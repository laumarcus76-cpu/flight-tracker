...
A lightweight personal tool that monitors SJC and OAK → Las Vegas (LAS) flights and sends
...
2. Fetches real-time prices from Google Flights via SerpAPI for both SJC→LAS and OAK→LAS
